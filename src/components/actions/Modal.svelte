<script lang="ts">
	...
	export let content: Action | undefined | null;
...
<Modal
	...
	classBg="z-50 fixed top-0 left-0 w-screen h-screen flex flex-col justify-center bg-black/30 "
	...
	classContent="relative p-4 overflow-auto"
	unstyled
	closeButton={false}
