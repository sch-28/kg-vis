<script lang="ts">
	...
	import { Graph, SimNode, type SimLink, type Triple } from './api/rdf.types';
	...
	function update_nodes() {
		...
		drag_handler(node_elements as unknown as d3.Selection<Element, unknown, any, any>);
	}
	...
	function create_graph() {
		...
		function ticked() {
			...
			svg.selectAll<d3.BaseType, SimNode>('.nodes g').attr('transform', function (d) {
